...
from task_manager.pomodoro_timer import Pomodoro_time
...
class TestPomodoro_timer(unittest.TestCase):
    ...
    def test_start_timer_to_work(self, mock_sleep):
        self.test_pomodoro_times = Pomodoro_time()
        self.test_pomodoro_times.work_time = 5
        test_timer = self.test_pomodoro_times.start_timer(
            self.test_pomodoro_times.work_time
        )
    ...
    def test_start_timer_to_brake_time(self, mock_sleep):
        ...
        test_timer = self.test_pomodoro_times.start_timer(
            self.test_pomodoro_times.short_brake_time
        )
        self.assertEqual(test_timer, "00:00")
